...
const saveVehicule = async () => {
  ...
  try {
    ...
    if (props.mode === 'edit') {
      response = await catalogueService.updateVehicule(props.catalogueUuid, props.categorieUuid, props.vehiculeUuid, vehiculeData);
      toast.add({
        severity: 'success',
        summary: 'Succès',
      ...
      response = await catalogueService.createVehicule(props.catalogueUuid, props.categorieUuid, vehiculeData);
      toast.add({
        severity: 'success',
        summary: 'Succès',
    ...
    // Redirection vers la liste des véhicules de la catégorie
    router.push(`/catalogue/${props.catalogueUuid}/categories/${props.categorieUuid}/vehicules`);
  } catch (error) {
        ...
        <div class="header-content">
          <div class="title-section">
            ...
            <p class="page-subtitle">
              <span v-if="catalogueName && categorieName">Pour la catégorie {{ categorieName }} du catalogue {{ catalogueName }}</span>
              <span v-else>{{ props.mode === 'edit' ? 'Modifiez les caractéristiques de votre véhicule' : 'Ajoutez un nouveau véhicule à votre catégorie' }}</span>
            </p>
          </div>
        </div>
      </div>
